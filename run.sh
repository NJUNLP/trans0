...
WANDB_PROJECT="zouw_debug" WANDB_NAME="llama3.2_baseline" torchrun --nproc_per_node $ARNOLD_WORKER_GPU --master_port $METIS_WORKER_0_PORT  main.py \
    --mode SFT  \
    --llm_path models/huggingface/Llama-3.2-3b-instruct/  \
